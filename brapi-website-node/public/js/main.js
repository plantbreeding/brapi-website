...
function toggleVisible(toggleId, btnId, displayTxt, hideTxt) {
    ...
    if (toggleElm.style.display === "block")
        btnElm.innerHTML = "<span class=\"mdi--chevron-double-up custom-bullet-point\"></span> " + displayTxt + " <span class=\"mdi--chevron-double-up custom-bullet-point\"></span>";
    else
        btnElm.innerHTML = "<span class=\"mdi--chevron-double-down custom-bullet-point\"></span> " + hideTxt + " <span class=\"mdi--chevron-double-down custom-bullet-point\"></span>";
}
